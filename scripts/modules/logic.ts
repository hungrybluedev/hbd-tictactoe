...
import { GameState, Turn, Status, Player } from "./types.js";

import {
  encoding_for,
  retrieve_grid_buttons,
  retrieve_ui_button,
  retrieve_message_box,
  retrieve_canvas,
  symbol_for,
} from "./pure_functions.js";

import {
  add_breathing_animation,
  disable_all_buttons,
...
export const toggle_player_mode = (previous_state: GameState): GameState => {
...
export const iterate_game_loop = (state: GameState) => {
  ...
  // Exit early if there has been no change.
